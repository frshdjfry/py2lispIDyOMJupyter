...
from py2lisp.configuration import get_timestamp, IDyOMConfiguration, ExperimentLogger
...
class IDyOMExperiment:
    ...
    def run(self):
        ...
        os.system("sbcl --dynamic-space-size 8192 --noinform --load " + self.generate_lisp_script())
        print(' ')
        print('** Finished! **')
